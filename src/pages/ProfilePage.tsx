...
const defaultProfile = {
    ...
    subscription: "Gambler",
    email: "hello@jeetoai.com",
    level: 42,
    currentExp: 2800,
    maxExp: 4000,
                ...
                <div className="flex items-start justify-between mb-6">
                    <div className="flex gap-4">
                        <div className="flex flex-col items-center">
                            ...
                            /> */}
                            <img src={avatar} alt={name} className="rounded-xl ring-2 ring-zinc-100 dark:ring-zinc-800 w-[64px] h-[64px] object-cover" />
                            <Badge
                                variant="secondary"
