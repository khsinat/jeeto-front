...
const transition = { type: "spring", bounce: 0, duration: 0.4 } as const;
...
export function Toolbar({
    ...
    const toolbarItems: ToolbarItem[] = [
        ...
        { id: "notifications", title: "Notifications", icon: Bell, link: "/notifications" },
        { id: "profile", title: "Profile", icon: User, link: "/profile" },
        { id: "Wallet", title: "Wallet", icon: Wallet, link: "/wallet" },
    ];
    ...
    const handleItemClick = (itemId: string) => {
        ...
        navigate(toolbarItems.find(item => item.id === itemId)?.link || "/");
    };

    return (
        <div className="space-y-2 fixed bottom-2 z-50 w-full px-4 ">
            <div
                ref={outsideClickRef}
                className={cn(
                    "flex items-center gap-3 p-2 relative justify-center h-[60px]",
                    "bg-background",
                    "border rounded-xl",
